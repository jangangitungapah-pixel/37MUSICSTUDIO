...
const LandingPage = () => {
  ...
  return (
    <div className="landing-container">
      ...
      {isLoginOpen && (
        <div className="nav-login-dropdown" role="dialog" aria-modal="true" aria-label="Login Staff">
      ...
      <section id="gallery" className="landing-gallery-section">
        <div className="section-header align-left">
          ...
          <p>Preview studio dibuat ringan untuk mobile. Galeri penuh tetap bisa dibuka saat kamu butuh lihat foto lain.</p>
        </div>

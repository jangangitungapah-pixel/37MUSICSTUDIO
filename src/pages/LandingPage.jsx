...
const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  ...
  return (
    <div className="landing-container tw-landing-phase80b min-h-screen w-full overflow-x-hidden bg-[#07070b] text-[#fffaf0] antialiased selection:bg-amber-300/30 selection:text-white tw-landing-phase80d">
      ...
      <section id="experience" className="experience-section mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative isolate overflow-hidden">
        <div className="section-header mx-auto mb-10 max-w-3xl text-center relative">
        ...
        <div className="experience-grid grid gap-4 md:grid-cols-3 relative">
          <div className="experience-card rounded-[1.75rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl shadow-black/10 backdrop-blur-xl transition hover:-translate-y-1 hover:border-amber-300/25 hover:bg-white/[0.07] group relative overflow-hidden">
            <div className="experience-icon mb-5 grid size-12 place-items-center rounded-2xl border border-amber-300/20 bg-amber-300/10 text-amber-100 shadow-lg shadow-amber-500/10 transition group-hover:scale-105">
              <Music2 size={26} />
            </div>
            <span className="experience-label mb-3 inline-flex rounded-full border border-white/10 bg-white/[0.045] px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.14em] text-stone-200/60">Rehearsal</span>
            <h3>Latihan band lebih fokus</h3>
            <p>Drum, ampli gitar, ampli bass, AC, dan ruang soundproof siap dipakai sejak awal sesi.</p>
          </div>

          <div className="experience-card featured rounded-[1.75rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl shadow-black/10 backdrop-blur-xl transition hover:-translate-y-1 hover:border-amber-300/25 hover:bg-white/[0.07] group relative overflow-hidden">
            <div className="experience-icon mb-5 grid size-12 place-items-center rounded-2xl border border-amber-300/20 bg-amber-300/10 text-amber-100 shadow-lg shadow-amber-500/10 transition group-hover:scale-105">
              <Mic2 size={26} />
            </div>
            <span className="experience-label mb-3 inline-flex rounded-full border border-white/10 bg-white/[0.045] px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.14em] text-stone-200/60">Recording</span>
          ...
          <div className="experience-card rounded-[1.75rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl shadow-black/10 backdrop-blur-xl transition hover:-translate-y-1 hover:border-amber-300/25 hover:bg-white/[0.07] group relative overflow-hidden">
            ...
            <span className="experience-label mb-3 inline-flex rounded-full border border-white/10 bg-white/[0.045] px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.14em] text-stone-200/60">Session assist</span>
      ...
      <section className="booking-flow-section mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8 relative isolate">
        <div className="flow-panel grid gap-6 rounded-[2rem] border border-white/10 bg-white/[0.05] p-5 shadow-2xl shadow-black/20 backdrop-blur-2xl md:grid-cols-[0.8fr_1.2fr] md:p-7 relative overflow-hidden">
          <div className="flow-copy relative z-10">
          ...
          <div className="flow-steps grid gap-3 sm:grid-cols-3 relative z-10" aria-label="Alur booking">
            <div className="flow-step rounded-3xl border border-white/10 bg-black/15 p-4 group transition hover:-translate-y-1 hover:border-cyan-200/25 hover:bg-white/[0.06]">
              <span>01</span>
      ...
      <section id="gallery" className="landing-gallery-section mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative isolate">
        <div className="section-header align-left mx-auto mb-10 max-w-3xl text-center relative">
      ...
      <section id="pricing" className="pricing-section mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:px-8 relative isolate">
        <div className="pricing-shell grid gap-6 rounded-[2rem] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/20 backdrop-blur-2xl md:grid-cols-[minmax(0,1fr)_360px] md:p-7 lg:p-8">
          <div className="pricing-copy relative z-10">
            ...
            <div className="pricing-includes mt-6 grid gap-3 sm:grid-cols-2" role="list" aria-label="Yang termasuk dalam harga">
          ...
          <div className="price-card relative overflow-hidden rounded-[1.75rem] border border-amber-300/20 bg-amber-300/[0.08] p-5 shadow-xl shadow-amber-500/10">
            <div className="price-card-top relative overflow-hidden rounded-[1.75rem] border border-amber-300/20 bg-amber-300/[0.08] p-5 shadow-xl shadow-amber-500/10 mb-4 flex items-center justify-between text-xs font-black uppercase tracking-[0.14em] text-amber-100/75">
              <span>Rate mulai dari</span>
              <Disc3 size={22} />
            </div>
            <div className="price-display mb-5 flex flex-wrap items-end gap-2">
              <span className="price-currency mb-2 text-xl font-black text-amber-200">Rp</span>
              <span className="price-amount text-5xl font-black tracking-[-0.07em] text-white">{formattedPrice}</span>
              <span className="price-unit mb-2 text-sm font-black text-stone-200/60">/ jam</span>
            </div>
            <Link to="/jadwal-publik" className="btn-primary btn-large inline-flex items-center justify-center gap-2 rounded-2xl bg-amber-300 px-5 py-3 font-black text-neutral-950 shadow-xl shadow-amber-500/20 transition hover:-translate-y-0.5 hover:bg-amber-200">
              <Calendar size={19} />
      ...
      <section className="proof-section mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="proof-grid grid gap-4 md:grid-cols-3" aria-label="Keunggulan studio">
          <div>
            <Volume2 size={20} />
      ...
      <footer id="location" className="landing-footer relative isolate mt-10 border-t border-white/10 bg-[#07070b] px-4 py-12 sm:px-6 lg:px-8">
        <div className="footer-content mx-auto grid w-full max-w-7xl gap-8 md:grid-cols-[minmax(0,1fr)_minmax(240px,0.5fr)_minmax(260px,0.6fr)]">
          <div className="footer-brand space-y-4">
            ...
            <div className="footer-social flex flex-wrap gap-2">
          ...
          <div className="footer-contact rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-5">
            <h3>Kontak studio</h3>
            <p>
              <MapPin size={17} />
            ...
            <p>
              ...
              <a
                ...
                className="footer-contact-link rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-5 font-black text-amber-200 transition hover:text-amber-100"
          ...
          <div className="footer-map overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/[0.04]">
            <h3>Alamat studio</h3>
